		...
		<form:form method="POST" modelAttribute="student"
			...
			<div class="container-fluid bg-2 text-center">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<label class="col-md-6 control-label" for="classid">Class</label>
							<div class="col-md-6">
								<form:input type="text" path="classid" id="classid"
									class="form-control input-md" />
								<div class="has-error">
									<form:errors path="classid" class="help-inline" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label class="col-md-6 control-label" for="sectionid">Section</label>
							<div class="col-md-6">
								<form:input type="text" path="sectionid"
									id="sectionid" class="form-control input-md" />
								<div class="has-error">
									<form:errors path="sectionid" class="help-inline" />
								</div>
							</div>
						</div>
					</div>
