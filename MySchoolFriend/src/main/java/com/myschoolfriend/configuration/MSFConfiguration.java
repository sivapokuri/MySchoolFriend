...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.myschoolfriend")
public class MSFConfiguration extends WebMvcConfigurerAdapter {
	...
	public JavaMailSender getMailSender() {
		...
		mailSender.setUsername("pokuri86@gmail.com");
		mailSender.setPassword("heartbeat123");
