...
<body>
	...
	<div class="container">
		<div class="text-center">
			<h1 class="nice">Add Section</h1>
		</div>
		<form:form method="POST" modelAttribute="addsection"
			...
			<div class="container-fluid bg-2 text-center">
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<label class="col-md-6 control-label" for="sectionname">Section
								Name</label>
							<div class="col-md-6">
								<form:input type="text" path="sectionname" id="sectionname"
									class="form-control input-md" />
								<div class="has-error">
									<form:errors path="sectionname" class="help-inline" />
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<label class="col-md-6 control-label" for="classid">Select class</label>
							<div class="col-md-6">
								<form:select path="classid" style="width: 100%">
