...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <br>
      ...
      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Student on board successful!</div>
		...
		<div class="container-fluid bg-3 text-center"> 
		  <div class="row">
		    <div class="col-sm-4">
		      ...
		      <img class="img-responsive margin" style="width:100%" alt="Image" src="static/images/StudentOnBoard.png">
		      </a>
		    </div>
		    <div class="col-sm-4">
		      <p>Employee OnBoard</p>
		      <a href="<c:url value='/staffonboard' />">
		      <img class="img-responsive margin" style="width:100%" alt="Image" src="static/images/teacherOnboard.png">
		      </a>
		    </div>
		    <div class="col-sm-4"> 
		      <p>Search/Edit Student</p>
		      <a href="<c:url value='/searchstudent' />">
		      <img class="img-responsive margin" style="width:100%" alt="Image" src="static/images/StudentOnBoard.png">
		      </a>
		    </div>
		  </div>
		  ...
		  <div class="row">
		    ...
		    <div class="col-sm-4">
		      <p>College Calendar</p>
 				<img class="img-responsive margin" style="width:100%" alt="Image" src="static/images/collegecalendar.png">		    </div>
		    <div class="col-sm-4"> 
		      <p>Notice Board</p>
		      <img class="img-responsive margin" style="width:100%" alt="Image" src="static/images/noticeboard.png">	
		    </div>
		  </div>
		</div>
    </div>
